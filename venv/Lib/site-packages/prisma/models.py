...
class User(bases.BaseUser):
    ...
    role: 'enums.Role'
    stories: Optional[List['models.Story']] = None
    chatMessages: Optional[List['models.ChatMessage']] = None
    files: Optional[List['models.File']] = None
    contents: Optional[List['models.GeneratedContent']] = None
    emailVerified: _bool
...
class Story(bases.BaseStory):
    """Represents a Story record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.StoryKeys']] = None,
        exclude: Optional[Iterable['types.StoryKeys']] = None,
        required: Optional[Iterable['types.StoryKeys']] = None,
        optional: Optional[Iterable['types.StoryKeys']] = None,
        relations: Optional[Mapping['types.StoryRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.StoryKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _Story_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _Story_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _Story_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _Story_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _Story_relational_fields:
                        raise errors.UnknownRelationalFieldError('Story', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid Story / {name} field.'
            ) from None
...
class GeneratedContent(bases.BaseGeneratedContent):
    """Represents a GeneratedContent record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.GeneratedContentKeys']] = None,
        exclude: Optional[Iterable['types.GeneratedContentKeys']] = None,
        required: Optional[Iterable['types.GeneratedContentKeys']] = None,
        optional: Optional[Iterable['types.GeneratedContentKeys']] = None,
        relations: Optional[Mapping['types.GeneratedContentRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.GeneratedContentKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _GeneratedContent_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _GeneratedContent_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _GeneratedContent_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _GeneratedContent_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _GeneratedContent_relational_fields:
                        raise errors.UnknownRelationalFieldError('GeneratedContent', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid GeneratedContent / {name} field.'
            ) from None
...
_User_fields: Dict['types.UserKeys', PartialModelField] = OrderedDict(
    [
        ...
        ('contents', {
            ...
            'is_list': True,
            'optional': True,
            'type': 'List[\'models.GeneratedContent\']',
            'is_relational': True,
            'documentation': None,
        }),
        ('emailVerified', {
...
_Story_relational_fields: Set[str] = {
        'user',
    }
_Story_fields: Dict['types.StoryKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
_GeneratedContent_relational_fields: Set[str] = {
        'user',
    }
_GeneratedContent_fields: Dict['types.GeneratedContentKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
model_rebuild(File)
model_rebuild(GeneratedContent)
