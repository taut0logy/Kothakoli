...
class BaseStory(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Story']] = 'Story'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.StoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.StoryActions[_PrismaModelT](client or get_client(), cls)
...
class BaseGeneratedContent(_PrismaModel):
    __prisma_model__: ClassVar[Literal['GeneratedContent']] = 'GeneratedContent'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.GeneratedContentActions[_PrismaModelT]':
        from .client import get_client

        return actions.GeneratedContentActions[_PrismaModelT](client or get_client(), cls)
