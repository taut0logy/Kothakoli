      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &quot;Welcome back to StoryGen AI. Let your imagination flow and create amazing stories with the power of AI.&quot;
            </p>
            <footer className="text-sm">The StoryGen AI Team</footer>
          </blockquote>
        </div>
      </div>
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sign in to your StoryGen AI account
              </CardDescription>
            </CardHeader>
            <CardContent>
